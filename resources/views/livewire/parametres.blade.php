<div class="w-full flex flex-col space-y-5">
    ...
    <div class="flex space-x-3 px-8 text-lg w-full bg-white dark:bg-gray-900 rounded shadow p-4 m-1 relative">

            <a wire:navigate.hover  href="{{url(app()->getLocale().'/Devoirs') }}" class="h-full flex items-center gap-1 w-full font-semibold hover:underline">
