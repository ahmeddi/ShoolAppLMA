<div class="w-full h-full  p-3   ">
    ...
    {{-- <div class= "flex justify-between my-3  items-baseline ">
        <a class=" px-5 hover:underline dark:text-gray-50" wire:navigate.hover href="{{url(app()->getLocale().'/Depenses/List') }}">
            {{ __('compt.fixe') }}
        </a> 
    </div> --}}
                        ...
                        <tr class="h-5 ">
                            <td class="px-6 py-2">
                                <a  class="  hover:underline " 
                                    @if ($dep->depance_ent_id  != null)
                                    wire:navigate.hover  href="{{url(app()->getLocale().'/Depense/'. $dep->ent->id) }}"
                                    @else
                                        href="#"
                                    @endif
                                    >
                            ...
                            <td class="px-6 py-2">
                                <div dir="ltr" class="w-full  text-right text-sm font-semibold text-gray-900 dark:text-gray-200">
                            ...
                            <td class="flex space-x-2 py-2 h-full items-center">
                                <div class="mx-4">
                                    <button wire:click="$dispatch('edit',{ ids: {{ $dep->id }} })" >
                                ...
                                <div>
                                    @can('admin')
                                        <button wire:click="$dispatch('dels',{ ids: {{ $dep->id }} })" class=" stroke-red-600">
