            ...
            <div  class="flex flex-col space-y-4 ">
                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <select  wire:model.defer='sexe'  class="inputs @error('sexe') reds @enderror" name="sexe"  required >
                    ...
                    <div class="flex flex-col space-y-1">
                      ...
                      <input wire:model.defer='ddn' class="inputs @error('ddn') reds @enderror" type="date"   required  />    
                    </div>
                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                    <div class="flex flex-col space-y-1">
                        <div class="flex justify-between">
                          <label   class="labels">{{ __('parent.nom') }}:</label>
                          @error('prname') <span class="danger">{{ $message }}</span> @enderror  
                        </div>
                        <input wire:model.defer='prname' class="inputs @error('prname') reds @enderror" type="text" required  />
                    </div>
                    ...
                    <div class="flex flex-col space-y-1">
                      ...
                      <input wire:model.defer='prnamefr' class="inputs @error('prnamefr') reds @enderror" type="text" required  />
                  </div>

                    <div  class="flex flex-col space-y-1">
                        <div class="flex justify-between">
                          <label for="eid"  class="labels">{{ __('parent.telephone') }}:</label>
                          @error('telephone') <span class="danger">{{ $message }}</span> @enderror  
                        </div>
                      <div class="flex w-full  relative ">
                        <input dir="ltr"  x-model="telephone" x-mask="99 99 99 99" wire:model.defer='telephone' class="inputs @error('telephone') reds @enderror" type="text" required  />
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <div  dir="ltr" class=" flex w-full">
                          <input dir="ltr" lang="fr"  wire:model='whcode'  class="inputs w-2/6 mx-1 @error('whatsapp') reds @enderror" type="text"  required  />
                    ...
                    <div class="flex flex-col space-y-1">
                        <div class="flex justify-between">
                          <label   class="labels">{{ __('parent.sexe') }}:</label>
                          @error('psexe') <span class="danger">{{ $message }}</span> @enderror  
                        </div>
                        <select  wire:model.defer='psexe'  class="inputs @error('psexe') reds @enderror" name="sexe"  required >
                            <option class="text-sm" value="0" >-----</option>
                            <option  class="text-sm" value="1">{{ __('etudiants.add-homme') }}</option>
                            <option class="text-sm" value="2">{{ __('etudiants.add-femme') }}</option>
                        </select>
                      ...
                      <div class="flex flex-col space-y-1">
                          ...
                          <select wire:change='num'    wire:model.defer="cls"   class="inputs @error('cls') reds @enderror">
                            <option value="">-----</option>
                      ...
                      <div class="flex flex-col space-y-1">
                        ...
                        <input  wire:model.defer='nb'  placeholder="{{ $nbs }}" class="inputs placeholder:text-teal-700/70 dark:placeholder:text-teal-400/70 @error('nb') reds @enderror" type="number"   required  />    
                      </div>
