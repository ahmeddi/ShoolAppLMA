              ...
              <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                  ...
                  <div class="w-full flex justify-between col-span-2">
                    <div class=" flex space-x-1 items-center">
                        <input id="jardin" wire:model='jardin' type="checkbox" @if ($jardin == 1) checked  @endif value="" class=" peer check " >
                        <label for="jardin"  class="flex items-center ">
                    ...
                    <div class=" flex space-x-1 items-center">
                      <input id="primaire" wire:model='primaire' type="checkbox" @if ($primaire == 1) checked  @endif value="" class=" peer check " >
                      <label for="primaire"  class="flex items-center ">
                          <div class="flex space-x-2 mx-2 ">
                              <div class="flex flex-col">
                                  <div class="text-sm capitalize font-semibold text-gray-900 dark:text-gray-200">
                                      <span class=""> </span>
                                      élémentaire 
                                  </div>
                              </div>
                    ...
                    <div class=" flex space-x-1 items-center">
                      <input id="college" wire:model='college' type="checkbox" @if ($college == 1) checked  @endif value="" class=" peer check " >
                      <label for="college"  class="flex items-center ">
                          <div class="flex space-x-2 mx-2 ">
                              <div class="flex flex-col">
                                  <div class="text-sm font-semibold text-gray-900 dark:text-gray-200">
                                      <span class=""> </span>
                    ...
                    <div class=" flex space-x-1 items-center">
                      <input id="lycee" wire:model='lycee' type="checkbox" @if ($lycee == 1) checked  @endif value="" class=" peer check " >
                      <label for="lycee"  class="flex items-center ">
                          <div class="flex space-x-2 mx-2 ">
                              <div class="flex flex-col">
                                  <div class="text-sm font-semibold text-gray-900 dark:text-gray-200">
                                      <span class=""> </span>
       ...
       <x-slot name='footer' >
          ...
          <div wire:loading.remove class="flex justify-between">
           ...
           <div class='px-10  flex space-x-3 justify-end items-center w-full'>
            ...
            <button wire:click='save'  type="button" class=" w-full inline-flex justify-center rounded-md border dark:border-gray-500 shadow-sm px-4 py-2 focus:outline-none bg-teal-600 hover:bg-teal-800 text-white dark:text-gray-900 dark:bg-gray-100 dark:hover:bg-gray-200 font-bold sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
