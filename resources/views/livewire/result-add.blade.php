<div class="flex  ">
    <div class="flex px-2  justify-items-center space-x-2">
        <div class="flex flex-col space-y-1 mx-4">
            ...
            <select wire:model.defer="classe"   class="inputs w-52  @error('classe') reds @enderror">
                <option value="">-----</option>
        ...
        <div class="flex flex-col space-y-1 mx-4">
            ...
            <select wire:model.defer="mat"   class="inputs w-52  @error('mat') reds @enderror @error('mats') reds @enderror">
                <option value="">-----</option>
                    @foreach ($mats as $mat)
        ...
        <div class="flex flex-col space-y-1 mx-4">
            ...
            <select wire:change='update' wire:model="sem"   class="inputs w-52  @error('sem') reds @enderror">
                <option value="">-----</option>
                    @foreach ($sems as $sem)
                        <option value="{{ $sem->id }}">
                            @if ( app()->getLocale() == 'ar')
        ...
        <div class="flex flex-col space-y-1 mx-8">
            <div class="flex justify-between">
            <label for="eid"  class="labels">{{ __('result.dev') }} :</label>
            @error('exam') <span class="danger ">{{ $message }}</span> @enderror  
            </div>
            <select wire:model.defer="exam"   class="inputs w-52  @error('exam') reds @enderror">
                <option value="">-----</option>
