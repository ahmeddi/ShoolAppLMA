    ...
    <x-dialog-modal wire:model='visible' >
        <x-slot name='title'>
            ...
            <div class="flex flex-col space-y-4 ">
                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <input wire:model.defer='nni' class="inputs @error('nni') reds @enderror" type="number" required  />
                    </div>
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <input wire:model.defer='nc' class="inputs @error('nc') reds @enderror" type="number" required  />
                    </div>
                </div>
         ...
         <x-slot name='footer' >
            ...
            <div wire:loading class=" w-full justify-center ">
                <div role="status ">
