              ...
              <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                  ...
                  <div class="flex flex-col space-y-1 col-span-2 w-full">
                    <div class="flex justify-between">
                      <label for="eid"  class="labels">{{ __('notes.son') }}:</label>
                      @error('prof') <span class="danger ">{{ $message }}</span> @enderror  
                    </div>
                    <input wire:model.defer='prof' class="inputs w-full  col-span-2 @error('prof') reds @enderror" type="text"   required  />               
                  </div>
                  <div class="flex flex-col space-y-1  w-full">
                      <div class="flex justify-between">
                        <label for="eid"  class="labels">{{ __('notes.pos') }}:</label>
                        @error('pos') <span class="danger ">{{ $message }}</span> @enderror  
                      </div>
                      <input wire:model.defer='pos' class="inputs w-full @error('pos') reds @enderror" type="text"   required  />               
                  </div>
                  <div class="flex flex-col space-y-1 w-full">
                    <div class="flex justify-between">
                      <label for="eid"  class="labels">{{ __('notes.lang') }}:</label>
                      @error('lang') <span class="danger ">{{ $message }}</span> @enderror  
                    </div>
                    <select  wire:model.defer='lang'  class="inputs w-full @error('lang') reds @enderror" name="lang"  required >
                      <option class="text-sm" value="null" >-----</option>
                      <option  class="text-sm" value="1">{{ __('notes.ar') }}</option>
                      <option class="text-sm" value="2">{{ __('notes.fr') }}</option>
                    </select>               
                  </div>
                  <div class="flex flex-col space-y-1 ">
                      <div class="flex justify-between">
                        <label for="eid"  class="labels">{{ __('notes.date') }}:</label>
                        @error('date') <span class="danger ">{{ $message }}</span> @enderror  
                      </div>
                      <input wire:model.defer='date' class="inputs   @error('date') reds @enderror" type="date"   required  />       
                  </div>
                  <div class="flex flex-col space-y-1 ">
                      <div class="flex justify-between">
                        <label for="eid"  class="labels">{{ __('notes.titr') }}:</label>
                        @error('titre') <span class="danger ">{{ $message }}</span> @enderror  
                      </div>
                      <input wire:model.defer='titre' class="inputs   @error('titre') reds @enderror" type="text"   required  />             
                  </div>
                  <div class="flex flex-col space-y-1 col-span-2 w-full ">
                      <div class="flex justify-between">
                        <label for="note"  class="labels"> {{ __('notes.text') }}:</label>
