         ...
         <x-slot name='content'>
            <div  class="flex flex-col space-y-4 ">
                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                    ...
                    <div class="flex flex-col space-y-1">
                      <div class="flex justify-between">
                        <label   class="labels">{{ __('parent.add-nomfr') }}:</label>
                    ...
                    <div class="flex flex-col space-y-1 col-span-2 w-full">
                        <div class="flex justify-between">
                          <label   class="labels">{{ __('parent.add-whats') }}:</label>
                          @error('whatsapp') <span class="danger">{{ $message }}</span> @enderror  
                        </div>
                        <div dir="ltr" class="flex w-full">
                          <input dir="ltr" lang="fr"  wire:model='whcode'  class="inputs w-1/6 mx-1 @error('whatsapp') reds @enderror" type="text"  required  />
                          <input dir="ltr" lang="fr" x-model="whatsapp" x-mask="99 99 99 99 99 99 99" wire:model.defer='whatsapp' class="inputs w-5/6 @error('whcode') reds @enderror" type="text" required  />
                        </div>
                    </div>
