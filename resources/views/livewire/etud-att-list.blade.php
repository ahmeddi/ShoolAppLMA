<div class="w-full h-full px-2  ">
    ...
    <div class=" w-full flex my-2 justify-between items-center px-2">
        <div class= "flex justify-between my-1">
            @cannot('parent')
                <div class= "flex justify-between my-3">
                    <button wire:click="$dispatch('pattl')" class='focus:outline-none px-4 py-2 dark:text-gray-900 dark:bg-gray-100 text-white rounded-md hover:outline-none bg-teal-600 hover:bg-teal-800' >
                        {{ __('att.add') }}
                    </button>   
                </div>
            @endcannot
                            ...
                            <tr class="h-5 ">
                                    ...
                                    @cannot('parent')
                                        <td class="flex space-x-2 py-2 h-full items-center">
                                            <div class="mx-4">
                                                <button   wire:click="$dispatchTo('etud-att-list-edit','open',{ id: {{ $hour->id }} })">
                                            ...
                                            <div>
                                                <button  wire:click="$dispatchTo('etud-att-list-del','open',{ id: {{ $hour->id }} })" class=" stroke-red-600">
