         ...
         <x-slot name='content'>
            <div x-data="{ open: 0 ,select: 0}" class="flex flex-col space-y-8 ">
                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center">
                      <div class="col-span-2 w-full flex flex-col space-y-2">
                        <div class="flex justify-between ">
                            <label   class="labels">{{ __('etudiants.etud') }} :</label>
                            @error('etud') <span class="danger">{{ $message }}</span> @enderror  
                        </div>
                      ...
                      <div class="col-span-2 w-full flex flex-col space-y-2">
                          <div class="flex justify-between ">
                              <label   class="labels">{{ __('compt.art') }} :</label>
                              @error('motif') <span class="danger">{{ $message }}</span> @enderror  
                          </div>
                          <select x-model="select"  wire:model="motif"   class="inputs w-full @error('motif') reds @enderror">
                            <option value="">-----</option>
                            <option value="1"> {{ __('compt.frais') }} </option>
                            <option value="2"> {{ __('compt.month') }} </option>
                          </select>     
                      </div>

                      <div x-show="select == 2" class=" w-full flex flex-col space-y-2">
                        <div class="flex justify-between ">
                            <label   class="labels"> {{ __('compt.month') }} :</label>
                            @error('month') <span class="danger">{{ $message }}</span> @enderror  
                        </div>
                        <select    wire:model="month"   class="inputs w-full @error('month') reds @enderror">
                            <option  value="">-----</option>
                      ...
                      <div x-show="select == 2" class=" w-full flex flex-col space-y-2">
                        <div class="flex justify-between ">
                            <label   class="labels">{{ __('compt.year') }} :</label>
                            @error('year') <span class="danger">{{ $message }}</span> @enderror  
                        </div>
                        <select    wire:model="year"   class="inputs w-full @error('year') reds @enderror">
                            <option value="">-----</option>
                      ...
                      <div class=" w-full flex flex-col space-y-2">
                        ...
                        <input dir="ltr" wire:model='montant' @class(['inputs w-full', 'reds' => $errors->has('montant')]) type="text" x-mask:dynamic="$money($input, '.', ' ')"   required  /> 
                      </div>                   
                </div>
